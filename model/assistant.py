...
#LLama
#model = (sdk.models.completions("gpt://b1g6rjppcrrhq56lsqr0/llama-lite/latest@tamr5f9eii5b4f02osc2v"))
...
if __name__ == "__main__":
    ...
    for i in range(len(test_test_data)):
          print(f'Пример {i + 1}\n')
          thread = create_thread()
          thread.write(test_test_data[i])
          response = assistant.run(thread).wait()
          print(response.text)
          process_data(response.text, test_test_data[i][71:])
          thread.delete()
